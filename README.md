Less language is an extension of css and this project compiles it into regular css. It adds several dynamic features into css: variables, expressions, nested rules, and so on. Our [wiki page](https://github.com/SomMeri/less4j/wiki/Supported-Less-Language) contains both overview of all these features and links to their detailed descriptions.  
