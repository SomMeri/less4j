...
class Antlr4_TokenFactory implements TokenFactory {
  ...
  @Override
  public Token create(Tuple2<? extends TokenSource, CharStream> source, int type, String text, int channel, int start, int stop, int line, int charPositionInLine) {
