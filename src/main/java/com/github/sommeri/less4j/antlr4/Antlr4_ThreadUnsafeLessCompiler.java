...
import com.github.sommeri.less4j.antlr4.core.parser.ANTLR4Parser;
import com.github.sommeri.less4j.antlr4.core.parser.ANTLR4Parser.ParserResult;
import com.github.sommeri.less4j.antlr4.core.parser.Antlr4_AstBuilder;
...
public class Antlr4_ThreadUnsafeLessCompiler implements LessCompiler {
  private ProblemsHandler problemsHandler;
  private Antlr4_AstBuilder astBuilder;
  private LessToCssCompiler compiler;

  private ANTLR4Parser parser = new ANTLR4Parser();
  ...
  public CompilationResult compile(LessSource source, Configuration options) throws Less4jException {
    ...
    astBuilder = new Antlr4_AstBuilder(problemsHandler);
  ...
  private CompilationResult doCompile(LessSource source, Configuration options) throws Less4jException {
    ParserResult result = toAntlrTree(source);
    StyleSheet lessStyleSheet = (StyleSheet)astBuilder.parse(result.getTree(), result.getComments());
  ...
  private ParserResult toAntlrTree(LessSource source) throws Less4jException {
    ParserResult result;
    try {
