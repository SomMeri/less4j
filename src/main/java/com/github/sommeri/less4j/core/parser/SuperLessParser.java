...
public abstract class SuperLessParser extends Parser {
  ...
  static {
    ...
    ALTERNATIVE_NAMES_FOR_ERROR_REPORTING.put("AT_CHARSET", "identifier");
    ALTERNATIVE_NAMES_FOR_ERROR_REPORTING.put("AT_KEYFRAMES", "identifier");
    ALTERNATIVE_NAMES_FOR_ERROR_REPORTING.put("AT_DOCUMENT", "identifier");
    ALTERNATIVE_NAMES_FOR_ERROR_REPORTING.put("AT_VIEWPORT", "identifier");
    ALTERNATIVE_NAMES_FOR_ERROR_REPORTING.put("AT_SUPPORTS", "identifier");
