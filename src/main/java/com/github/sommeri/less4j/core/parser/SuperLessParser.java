...
public abstract class SuperLessParser extends Parser {
  ...
  static {
    ...
    ALTERNATIVE_NAMES_FOR_ERROR_REPORTING.put("IDENT_WHEN", "identifier");

    ALTERNATIVE_NAMES_FOR_ERROR_REPORTING.put("IDENT_NTH_CHILD", "identifier");
    ALTERNATIVE_NAMES_FOR_ERROR_REPORTING.put("NTH_LAST_CHILD", "identifier");
    ALTERNATIVE_NAMES_FOR_ERROR_REPORTING.put("NTH_OF_TYPE", "identifier");

    ALTERNATIVE_NAMES_FOR_ERROR_REPORTING.put("NTH_LAST_OF_TYPE", "identifier");
    ALTERNATIVE_NAMES_FOR_ERROR_REPORTING.put("IDENT_EXTEND", "identifier");
    ALTERNATIVE_NAMES_FOR_ERROR_REPORTING.put("IDENT_NOT", "identifier");
    ALTERNATIVE_NAMES_FOR_ERROR_REPORTING.put("IDENT_AND", "identifier");
    ALTERNATIVE_NAMES_FOR_ERROR_REPORTING.put("IDENT_OR", "identifier");
    ...
    ALTERNATIVE_NAMES_FOR_ERROR_REPORTING.put("AT_NAME", "@<name>");
    ALTERNATIVE_NAMES_FOR_ERROR_REPORTING.put("AT_CHARSET", "@<name>");
    ALTERNATIVE_NAMES_FOR_ERROR_REPORTING.put("AT_KEYFRAMES", "@<name>");
    ALTERNATIVE_NAMES_FOR_ERROR_REPORTING.put("AT_DOCUMENT", "@<name>");
    ALTERNATIVE_NAMES_FOR_ERROR_REPORTING.put("AT_VIEWPORT", "@<name>");
    ALTERNATIVE_NAMES_FOR_ERROR_REPORTING.put("AT_SUPPORTS", "@<name>");
