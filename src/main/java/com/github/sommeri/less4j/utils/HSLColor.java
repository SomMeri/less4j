 ...
 * 
 * [Source http://tips4java.wordpress.com/2009/07/05/hsl-color/]
 */
public class HSLColor {
   ...
   * This is a convenience method. The complementary color is determined by
   * adding 180 degrees to the Hue value.
   * 
   * @return the RGB Color object
   */
  ...
  public String toString() {
    String toString = "HSLColor[h=" + hsl[0] + ",s=" + hsl[1] + ",l=" + hsl[2]
	+ ",alpha=" + alpha + "]";
  ...
  /**
   * Convert HSL values to a RGB Color with a default alpha value of 1. H (Hue)
   * is specified as degrees in the range 0 - 360. S (Saturation) is specified
   * as a percentage in the range 1 - 100. L (Lumanance) is specified as a
