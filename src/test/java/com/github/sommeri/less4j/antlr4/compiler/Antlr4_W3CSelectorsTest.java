 ...
 *
 */
public class Antlr4_W3CSelectorsTest extends Antlr4_AbstractFileBasedTest {
  ...
  public Antlr4_W3CSelectorsTest(File inputFile, File outputFile, File errorList, File mapdataFile, String testName) {
