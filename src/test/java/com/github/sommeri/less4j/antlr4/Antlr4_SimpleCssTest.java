...
public class Antlr4_SimpleCssTest extends Antlr4_AbstractFileBasedTest {
  ...
  public Antlr4_SimpleCssTest(File inputFile, File outputFile, File errorList, File mapdataFile, String testName) {
