...
import com.github.sommeri.less4j.antlr4.Antlr4_ThreadUnsafeLessCompiler;
...
public abstract class AbstractFileBasedTest {
  ...
  public AbstractFileBasedTest(File lessFile, File cssOutput, File errorList, File mapdataFile, String testName) {
    ...
    String string = lessFile.getAbsolutePath();
    string = string.replace("\\", "\\\\");

    try {
      FileUtils.writeStringToFile(new File("C:\\data\\meri\\less4java\\workspace-juno-sr2-3\\allFiles.txt"), string+"\n", true);
    } catch (IOException e) {
